  ...
  <q-layout class="bg-grey-1">
    <q-header elevated height-hint="61.59">
      <q-toolbar class="q-py-sm q-px-md">
        <q-btn round dense flat :ripple="false" icon="photo" size="19px" color="white" class="q-mr-sm" no-caps />
        ...
        >
          ...
          <template v-slot:append>
            <img src="/icons/img-github-search-key-slash.svg">
          </template>
        ...
        <div class="q-pl-sm q-gutter-sm row items-center no-wrap">
          ...
          <q-btn v-if="$q.screen.gt.xs" dense flat>
            ...
            <q-menu auto-close>
              <q-list dense style="min-width: 100px">
                ...
                <q-item clickable class="GL__menu-link">
                  <q-item-section>Action 4</q-item-section>
                </q-item>
                <q-separator />
                <q-item-label header>Action 5</q-item-label>
                <q-item clickable class="GL__menu-link">
                  <q-item-section>Action 5.1</q-item-section>
                </q-item>
              </q-list>
            </q-menu>
          </q-btn>
          ...
          <q-btn dense flat no-wrap>
            <q-avatar rounded size="20px" color="white" icon="account-circle" >
            </q-avatar>
